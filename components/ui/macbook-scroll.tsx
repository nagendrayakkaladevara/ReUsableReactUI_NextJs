...
import CodeImage from '../../asserts/buttonvscodeimage.png';
...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="flex flex-col items-center py-0  justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
        >
            <motion.h2
                style={{
                ...
                className="dark:text-white text-neutral-800 text-xl font-bold mb-20 text-center"
            >
                {title || (
                    <span>
